...
# lib_dir = os.path.join(module_dir, '..', 'lib', '64')
# lib_file = 'libMvCameraControl.so'
# curr_dir_before = os.getcwd()
# os.chdir(lib_dir)
# # MvCamCtrldll = ctypes.cdll.LoadLibrary(lib_file) # doesnt work on ubuntu 22.04 x64
# MvCamCtrldll = ctypes.cdll.LoadLibrary(os.path.join(os.getcwd(), lib_file))
